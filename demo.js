...
app.listen(PORT, () => {
  ...
  console.log('📖 Visit http://localhost:3000 for API documentation and test commands\n');
  
  console.log('🧪 Quick Test Commands:');
  console.log(`curl -X GET "http://localhost:${PORT}/api/users"`);
  console.log(`curl -X GET "http://localhost:${PORT}/api/chats?userId=${sampleData.user1Id}"`);
  console.log(`curl -X GET "http://localhost:${PORT}/api/chats/${sampleData.chatId}/messages"`);
  console.log('');
});
